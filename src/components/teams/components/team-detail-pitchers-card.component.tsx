...
export function TeamDetailPitchersCard({ pitchers, bandColor, textColor }: TeamDetailPitchersCardProps) {
  ...
  return (
    <Card className="mx-4">
      <TeamDetailCardHeader label="Pitchers" bandColor={bandColor} textColor={textColor} />
